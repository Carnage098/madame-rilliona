# Madame Rilliona V2.8 — catalogue autonome
...
## V2.8 — Autocomplétion distante

`/carte rechercher` propose maintenant des résultats provenant de PostgreSQL et de YGOPRODeck. La carte sélectionnée est ensuite récupérée par identifiant et enregistrée avec ses informations françaises et anglaises.
